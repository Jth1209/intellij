package edu.du.proj_11m.board;

import edu.du.proj_11m.board.entity.BoardDto;
import edu.du.proj_11m.board.entity.BoardFileDto;
import edu.du.proj_11m.board.service.BoardService;
...
//	private final AuthenticationConfiguration authenticationConfiguration;
	...
	public String insertBoard(BoardDto board, MultipartHttpServletRequest multipartHttpServletRequest , HttpSession session) throws Exception{
		board.setCreatorId(((AuthInfo)session.getAttribute("authInfo")).getName());
...
//	}
	...
	public String openBoardDetail(@RequestParam int boardIdx , Model model , HttpSession session) throws Exception{
		...
		model.addAttribute("uname", authInfo.getName());
